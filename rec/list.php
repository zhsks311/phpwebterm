...
include ("../db_conn.php");
include ("../session.php");
$table = isset($_GET['table'])?$_GET['table']:"rec";
$ripple = "rec_ripple";
...
<div id="wrap">
    ...
    <div id="content">
		<div id="col2">
			<div id="title">
				<img src="../imgs/titleRec.gif">
			</div>
			<form  name="board_form" method="post" action="list.php?table=<?php echo $table?>&mode=search">
				<div id="list_search">
			...
			<div id="list_content">
				...
				for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)
				{
					...
					<div id="list_item">
						...
						<div id="list_item2"><a href="view.php?table=<?php echo $table?>&num=<?php echo $item_num?>&page=<?php echo $page?>"><?php echo $item_subject ?></a>
							<?php
							if ($num_ripple)
								echo " [$num_ripple]";
							?>
				...
				<div id="page_button">
					...
					<div id="button">
						...
						{
							?>
                            <a href="write_form.php?table=<?=$table?>&mode=<?=$mode?>"><img src="../img/write.png"></a>
							<?php
						}
                        ?>
					</div>
